...
public class Credentials extends HttpServlet 
{
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		try
		{
			...
			String fromEmail="brobankjava@gmail.com"; //sender's mail id.
			String pwd= "6%M+n4u6";		//sender's mail pwd.
			String toEmail=email;  //reciever's mail id.

			String subject="DO NOT REPLY: Mail from Java Program"; // mail subject line
			String msg="Enter the link to reset your password"+"http://localhost:9090/BankApp/changeNPwd.jsp"; //mail body
